...
export default function WorkSpaceSelector({ workspace, selected }) {
  ...
  return (
    <div
      className="w-full h-full flex  hover:bg-[#4D96DA] rounded-md p-6 content-center flex-wrap cursor-pointer"
    ...
    >
      ...
      />
      <div className="dark:text-white text-[18px] ml-2">{workspace.name}</div>
      <div className="relative left-[50%] dark:text-white cursor-pointer   ">
        <Popup
          ...
          {(close) => (
            <div className="w-full h-full flex flex-col">
              ...
              <div className="w-full h-[30%] flex  flex-wrap  ">
                ...
                >
                  {emailError === "x" ? (
                    <img src={Loadingbar} alt="sending" />
                  ) : (
                    "Send"
                  )}
                </button>
